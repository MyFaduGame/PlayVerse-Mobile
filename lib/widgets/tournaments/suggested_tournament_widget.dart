...
class SuggestedTournamentWidget extends StatefulWidget {
  const SuggestedTournamentWidget({super.key});

  @override
  State<SuggestedTournamentWidget> createState() =>
      _SuggestedTournamentWidgetState();
}

class _SuggestedTournamentWidgetState extends State<SuggestedTournamentWidget> {
  ...
  Future<void> paginationTournaments() async {
    ...
    await provider.getSuggestedTournaments(offsetUpcoming).then((value) {
